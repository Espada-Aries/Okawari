...
<script>
	function inputCheck() {
		if (document.frm.orderNumber.value.length == 0) {
			alert("注文番号を入れて下さい。");
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<form name="frm" action="customerOrderCancle.okawari"
									method="post">
									<table class="table">
										<thead class=" text-primary">
											...
											<th><input type="text" class="text-control"
												...
												style="width: 100%;"></th>
											<th><input type="submit" class="btn btn-primary btn-round"
												onclick="return inputCheck()" value="転送"
												...
												<tbody>
													<c:if test="${customerOrderList != null }">
														<c:forEach var="list" items="${customerOrderList }">
															<fmt:parseNumber var="danga" integerOnly="true"
																value="${list.order_perprice / list.order_count}" />
															<tr>
														...
														<tr>
															<td></td>
															<td class="text-center">[${customerOrderTot.order_date  }]</td>
															<td class="text-center">[${customerOrderTot.order_time }]</td>
															<td class="text-center">[${customerOrderTot.order_totprice }]</td>
														</tr>
													</c:if>
												</tbody>
											</table>
										</c:if>
										<input type="submit"  class="btn btn-primary btn-round" value="取り消し"  />
									</form>
								</div>
							</div>
						</div>
