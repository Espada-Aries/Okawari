...
<script>
   function dayCheck2() {
      if (document.frm2.start.value.length == 0) {
         alert("日付を入れて下さい。");
         frm.start.focus();
         return false;

      }
      if (document.frm2.end.value.length == 0) {
         alert("日付を入れて下さい。");
         frm.end.focus();
         return false;
...
<body>
   <div class="wrapper ">
      <div class="sidebar" data-color="white" data-active-color="danger" style ="padding: 0px;">
         <!--
               ...
               <div class="col-md-12">
                  <div class="card">
                     ...
                     <div class="card-body" style ="padding-top: unset;">
                        <form name="frm" action="userProfit.okawari" method="post">
                           <input type="text" name="day" id="day"
                              placeholder="日付を選んでください。">&nbsp;&nbsp; <input
                              type="submit" class="btn btn-primary btn-round" onclick="return dayCheck()" value="売り上げ閲覧" />
                        </form>
                        <br>
                        <c:if test="${salesDTO != null }">
                           <form
                              action="userProfit.okawari?dayUpdate=${salesDTO.sales_date }"
                              method="post">
                              ...
                              <div class="table-responsive" style ="margin: auto;">
                                 <table class="table">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          <td colspan="5" align="center"><input type="submit" class="btn btn-primary btn-round"
                                             value="売り上げ精算" style="margin-left:-7px;" /></td>
                                       </tr>
                                    </tbody>
                                 </table>
                              </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="card">
                           ...
                           <div class="card-body" style ="padding-top: unset;">
                              <form name="frm2" action="userProfit.okawari" method="post">
                                 <table style = "float: left;">
                                    <tr>
                                       <td style="padding-right: 5px;"><input type="text" name="start" id="start"
                                          placeholder="開始日（クリック）"></td>
                                       <td style="padding-right: 5px;"><input type="text" name="end" id="end"
                                          placeholder="終了日（クリック）"></td>
                                       <td style="padding-right: 5px;"><input type="submit" class="btn btn-primary btn-round" value="閲覧"
                                          onclick="return dayCheck2()" /></td>
                                    </tr>
                                 </table>
                              </form>
                              ...
                              <c:if test="${salesList != null }">
                                ...
                                <div id ="main-content" style = "display: inline-block; width: 100%;">
