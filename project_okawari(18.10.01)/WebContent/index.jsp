...
<script language="javascript"> 
   ...
   function open_win()
   {
    window.open('findIdPasswd.jsp','popup', 'width=600, height=400, left=0, top=0, toolbar=no, location=no, directories=no, status=no, menubar=no, resizable=no, scrollbars=no, copyhistory=no');
   }
</script>
...
.form-4 input[type=button] {
   /* Size and position */
    ...
    margin-right: 31px;
    padding: 4px;
    background: linear-gradient(rgba(64, 80, 99, 0.5), rgba(49, 54, 76, 0.7));
    border-radius: 5px;
    border: 1px solid #4e3043;
                     ...
                     <div id="login" style = " position: absolute; width: 200px; height: 200px; top: 50%; left: 50%; margin: 150px 0 0 -100px;">
                        <form action="login.okawari" method=post class="form-4">
                           ...
                           <input class="box_style" type="text" name="user_id"
                              placeholder="ID" /><br/><input class="box_style"
                              type=password name="user_pass" placeholder="Password" />
                           <br/> <input type=submit value="ログイン"
                              style="margin-right: 15px;" />
                           <br/><br/><input type="button" value="ID&nbsp;/パスワード探し" onClick="javascript:open_win();"/>
