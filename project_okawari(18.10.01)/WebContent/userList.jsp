                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 <c:forEach var="list" items="${userList }">
                                    <tr>
                                       <td class="text-center" style = "width:100px;">${list.user_name }</td>
                                       <td class="text-center" style = "width:100px;">${list.user_manager }</td>
                                       <td class="text-left" style = "width:370px;">${list.user_addr }</td>
                                       <td class="text-center"style = "width:150px;">${list.user_phone }</td>
                                       <td class="text-center" style = "width:150px;">${list.user_businum }</td>
                                       <td class="text-center">${list.user_opendate }</td>
                                       <td align="center"
                                          style="font-family: 'Sawarabi Mincho', sans-serif;"><c:if
                                             ...
                                             <div style="margin: 0 auto; width: 70px; height: 76px;">
                                                <input type="button" class="btn btn-primary btn-round"
                                                   value="修正"
                                                   style =" margin: unset; margin-bottom: 3px;"
