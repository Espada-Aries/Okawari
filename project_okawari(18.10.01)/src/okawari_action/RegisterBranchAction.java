...
public class RegisterBranchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		// 받은 내용을 담을 객체를 생성합니다.
		UserDTO dto = new UserDTO(user_id, user_pass, 2, user_name, user_manager, user_addr, user_phone,
				user_businum, user_commission, user_opendate);
		// 지점에서 사용할 고객전용 아이디 생성
		UserDTO dtoc = new UserDTO(String.valueOf(user_id + "c"), String.valueOf(user_pass + "c"), 3, user_name,
