...
import okawari_action.FindIdPasswdAction;
...
import okawari_action.OrderCustomerListAction;
...
public class Frontcontroller extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response)
		...
		else if (command.equals("/orderCustomerList.okawari")) {
			action = new OrderCustomerListAction();
			try {
				af = action.execute(request, response);
			} catch (Exception e) {
				e.printStackTrace();
		...
		else if (command.equals("/findIdPasswd.okawari")) {
			action = new FindIdPasswdAction();
			try {
				af = action.execute(request, response);
			} catch (Exception e) {
				e.printStackTrace();
